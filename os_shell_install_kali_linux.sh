echo "\e[93m+----------------------------------+"
echo "\e[93m|      THIS SCRIPT IS MADE BY      |"
echo "\e[93m|        PARTHA SARATHI DEY        |"
echo "\e[93m+----------------------------------+"
sleep 4
clear
echo "\e[93m|Updating and upgrading all the packages...\n\n"
sleep 2
apt update && apt upgrade -y
clear
echo "\e[93mInstalling wget...\n\n"
sleep 2
apt install wget -y
clear
echo "\e[93mInstalling python...\n\n"
sleep 2
apt install python -y
clear
echo "\e[93mUpdating and upgrading all the packages again...\n\n"
sleep 2
pkg update && pkg upgrade -y
clear
echo "\e[93mInstalling screenfetch...\n\n"
sleep 2
pkg install screenfetch -y
clear
echo "\e[93mInstalling figlet...\n\n"
sleep 2
